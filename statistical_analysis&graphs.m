...
title("G1:EchoPackets with delay response times - 02/12/2020 04:09:38-04:13:53 - E1809- IP:87.202.101.23")
...
title("G2:EchoPackets Throughput with MA filter of 8 secs - 02/12/2020 04:09:38-04:13:53 - E1809- IP:87.202.101.23");
xlabel("n.of second");
...
title("G3:EchoPackets without delay response times - 02/12/2020 04:13:53-04:18:08 - E0000- IP:87.202.101.23")
ylabel("Response Time in milliseconds")
xlabel("n. of packet")
...
title("G4:EchoPackets no delay Throughput with MA filter of 8 secs- 02/12/2020 04:13:53-04:18:08 - E0000- IP:87.202.101.23");
xlabel("n.of second");
ylabel("Throughput in bps (bits/second)");
...
title("G5: Histogram of response times of echo packets with delay - 02/12/2020 04:09:38-04:13:53 - E1809- IP:87.202.101.23");
ylabel("frequency");
xlabel("values");
...
title("G6: Histogram MA filtered throughput of echo packets with delay - 02/12/2020 04:09:38-04:13:53 - E1809- IP:87.202.101.23")
ylabel("frequency");
xlabel("values");
...
title("G7: Histogram of response times of echo packets without delay - 02/12/2020 04:13:53-04:18:08 - E0000- IP:87.202.101.23")
ylabel("frequency");
xlabel("values");
...
title("G8: Histogram MA filtered throughput of echo packets without delay - 02/12/2020 04:13:53-04:18:08 - E1809- IP:87.202.101.23")
ylabel("frequency");
xlabel("values");
...
hold on;
plot(RTO);
title("R1 diagram - RTT from delayed echo packets - 02/12/2020 04:09:38-04:13:53 - E1809- IP:87.202.101.23");
...
title("Histogram of echo Packets Delay - E1809 - IP:87.202.101.23");
...
figure();
plot(f,P1) ;
title('Single-Sided Amplitude Spectrum of our frequency sample - IP:87.202.101.23 ');
...
axis([0 1500 -20 20])
title("G9: First 1500 samples of the Frequency generator sample (DPCM) - 02/12/2020 04:19:33-04:20:24 - A1145 - IP:87.202.101.23");
xlabel("n.of Sample");
ylabel("Amplitude");
...
axis([0 1500 -20 20])
title("G10: First 1500 samples of the song(Zeibekiko Olybiadas – Stavros Xarhakos) sample (DPCM)- 02/12/2020 04:20:36-04:21:26 - A1145 - IP:87.202.101.23");
xlabel("n.of Sample");
ylabel("Amplitude");
...
title("G11:Histogram of Samples Differences - DPCM song(Zeibekiko Olybiadas – Stavros Xarhakos) - 02/12/2020 04:20:36-04:21:26 - A1145 - IP:87.202.101.23")
ylabel("Absolute frequency");
xlabel("values");
...
title("G12:Histogram of Actual Samples - DPCM song(Zeibekiko Olybiadas – Stavros Xarhakos) - 02/12/2020 04:20:36-04:21:26 - A1145 - IP:87.202.101.23")
ylabel("Absolute frequency");
xlabel("values");
...
title("G13: Histogram of Samples Differences - AQDPCM song1(Patrida M’, Araevo Se – Stelios kazantzidis) - 02/12/2020 04:21:38-04:22:16 - A1145 - IP:87.202.101.23")
ylabel("Absolute frequency");
xlabel("values");
...
title("G14: Histogram of Actual Samples - AQDPCM song1(Patrida M’, Araevo Se – Stelios kazantzidis) - 02/12/2020 04:21:38-04:22:16 - A1145 - IP:87.202.101.23")
ylabel("Absolute frequency");
xlabel("values");
...
title("G15: Mean Value of AQDPCM quantiazer -  song1(Patrida M’, Araevo Se – Stelios kazantzidis) - 02/12/2020 04:21:38-04:22:16 - A1145 - IP:87.202.101.23")
...
title("G16: Step of AQDPCM quantiazer -  song1(Patrida M’, Araevo Se – Stelios kazantzidis) - 02/12/2020 04:21:38-04:22:16 - A1145 - IP:87.202.101.23")
...
title("G17: Mean Value of AQDPCM quantiazer -  song2(Min Paracharazete tin istoria) - 02/12/2020 04:22:29-04:23:07 - A1145 - IP:87.202.101.23")
ylabel("Mean Value of Quantizer");
xlabel("Index of Mean Value");
...
title("G18: Step of AQDPCM quantiazer -  song2(Min Paracharazete tin istoria) - 02/12/2020 04:22:29-04:23:07 - A1145 - IP:87.202.101.23")
ylabel("Step value of Quantizer");
xlabel("Index Step value");
...
hold on;
plot(copterData1(:,3));
title("G19: Ithaki Copter 1st Telemetry Data - 02/12/2020 04:23:19 - 04:23:59  - Q2463(not-used) - IP:87.202.101.23");
ylabel("values");
...
hold on;
plot(copterData2(:,3));
title("G20: Ithaki Copter 2nd Telemetry Data - 02/12/2020 04:24:11 - 04:24:50- Q2463(not-used) - IP:87.202.101.23");
ylabel("values");
xlabel("n. of Response");
...
title("OBD-II vehicle - Engine Run Time - 02/12/2020 04:25:03 - 04:29:08 - V7291 - IP:87.202.101.23");
...
title("OBD-II vehicle - Intake Air Temperature - 02/12/2020 04:25:03 - 04:29:08 - V7291 - IP:87.202.101.23");
ylabel("Intake Air Temperature (^oC)")
xlabel("n. of request");

figure()
plot(OBD_ThrottlePosition);
title("OBD-II vehicle - Throttle Position - 02/12/2020 04:25:03 - 04:29:08 - V7291 - IP:87.202.101.23");
ylabel("value")
xlabel("Throttle Position (%)");

figure()
plot(OBD_EngineRPM);
title("OBD-II vehicle - Engine RPM - 02/12/2020 04:25:03 - 04:29:08 - V7291 - IP:87.202.101.23");
ylabel("Engine RPM")
xlabel("n. of request");

figure()
plot(OBD_vehicle_Speed);
title("OBD-II vehicle - Vehicle Speed - 02/12/2020 04:25:03 - 04:29:08 - V7291 - IP:87.202.101.23");
ylabel("Vehicle Speed (Km/h)")
xlabel("n. of request");

figure()
plot(OBD_CoolantTemperature);
title("OBD-II vehicle - Coolant Temperature - 02/12/2020 04:25:03 - 04:29:08 - V7291 - IP:87.202.101.23");
